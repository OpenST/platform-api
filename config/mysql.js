...
// ost_infra database
mysqlConfig['databases'][coreConstants.OST_INFRA_MYSQL_DB] = ['cluster7'];

// ost_analytics database
mysqlConfig['databases'][coreConstants.OST_ANALYTICS_MYSQL_DB] = ['cluster8'];
