/**
 * Module to execute recovery by recovery controller.
 *
...
/**
 * Class to execute recovery by recovery controller.
 *
 * @class ExecuteRecovery
 */
class ExecuteRecovery extends DeviceRecoveryBase {
  /**
   * Constructor to execute recovery by recovery controller.
   *
   * @param {object} params
