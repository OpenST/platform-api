/**
 * Module to verify abort recovery by controller transaction.
 *
 * @module lib/deviceRecovery/byRecoveryController/abortRecovery/VerifyTransaction
 */
...
/**
 * Class to verify abort recovery by controller transaction.
 *
 * @class VerifyTransaction
 */
class VerifyTransaction extends DeviceRecoveryBase {
  /**
   * Constructor to verify abort recovery by controller transaction.
   *
   * @param {object} params
