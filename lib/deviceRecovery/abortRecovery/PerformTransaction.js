 ...
 *
 * @module lib/deviceRecovery/abortRecovery/PerformTransaction
 */
...
class AbortRecovery extends DeviceRecoveryBase {
    ...
    if (
      ...
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_dr_ar_pt_1',
  ...
  async _performTransaction() {
    ...
    const decodedSignature = basicHelper.generateRsvFromSignature(oThis.signature),
      ...
      txObject = recoveryHelperObj.abortRecoveryByOwnerRawTx(
    ...
    const txOptions = {
      ...
      gas: contractConstants.abortRecoveryGas,
...
InstanceComposer.registerAsShadowableClass(AbortRecovery, coreConstants.icNameSpace, 'PerformAbortRecoveryTransaction');
