 ...
 *
 * @module lib/deviceRecovery/abortRecovery/VerifyTransaction
 */
...
class VerifyTransaction extends DeviceRecoveryBase {
  ...
  /**
   * Update recovery operation status as completed or failed.
   *
  ...
  async _updateRecoveryOperationStatus(transactionVerified) {
    const oThis = this,
      status = transactionVerified
        ? recoveryOperationConstants.invertedStatuses[recoveryOperationConstants.completedStatus]
