...
class VerifyAuthorize {
  ...
  async _fetchEventsData() {
    ...
    console.log('====eventsRsp==', eventsRsp);
  ...
  async _markAuthorizedInDevicesTable() {
    ...
    let paramsToUpdateDeviceStatus = {
      ...
      shardNumber: 1, //will be present in user data.Todo
...
InstanceComposer.registerAsShadowableClass(VerifyAuthorize, coreConstants.icNameSpace, 'VerifyAuthorizeTransaction');
