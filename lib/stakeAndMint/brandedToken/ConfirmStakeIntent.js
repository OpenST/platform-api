...
class ConfirmStakeIntentForBt extends ConfirmStakeIntentBase {
  ...
  async _fetchGatewayAddresses() {
    ...
    oThis.originGatewayContractKind = addressesResp.data[tokenAddressConstants.tokenGatewayContract];

    oThis.auxCoGatewayContractKind = addressesResp.data[tokenAddressConstants.tokenCoGatewayContract];
  }
}
