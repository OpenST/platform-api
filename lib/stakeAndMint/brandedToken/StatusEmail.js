...
class SendStakeAndMintStatusEmail {
  ...
  async perform() {
    ...
    await new SendTransactionalMail({
      ...
      templateVars: {
        ...
        [pepoCampaignsConstants.platformDashboardUrl]: `${coreConstants.SA_VIEW_BASE_URL}${environmentInfo.urlPrefix}`
      }
    }).perform();
  ...
  async _createUpdateContactHook() {
    ...
    let clientMileStoneHook = new ClientMileStoneHook({
      ...
      receiverEntityKind: emailServiceConstants.clientReceiverEntityKind,
      customAttributes: {
        [pepoCampaignsConstants.stakeAndMintAttribute]: pepoCampaignsConstants.attributeSet
      },
      userSettings: {},
