 ...
 * Check step status.
 *
 * @module lib/stakeAndMint/common/CheckProgressMintStatus
 */
...
const rootPrefix = '../../..',
  ...
  StakeAndMintBase = require(rootPrefix + '/lib/stakeMintManagement/Base');
 ...
 * @class
 */
class CheckProgressMintStatus extends StakeAndMintBase {
  /**
   * @constructor
   *
   * @param params
...
module.exports = CheckProgressMintStatus;
