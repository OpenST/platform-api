...
class AuxGethSetup {
  ...
  async asyncPerform() {
    ...
    logger.step('Funding origin addresses with eth.');
    await oThis.fundOriginAddresses();
  ...
  async fundOriginAddresses() {
    ...
    await oThis._fundAddressWithEth(oThis.originAnchorOrgContractOwnerAddress, 0.00006);
  }
