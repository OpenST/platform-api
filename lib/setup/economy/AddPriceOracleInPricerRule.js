 ...
 *
 *
 * @module lib/setup/economy/AddPriceOracleInPricerRule
 */
...
class AddPriceOracleToPricerRule {
  ...
  async _getPriceOracleContractAddr() {
    ...
    logger.debug('chainAddressCacheRsp-------', chainAddressCacheRsp);

    oThis.priceOracleContractAddr = chainAddressCacheRsp.data[chainAddressConstants.auxDeployerKind].address;
  }
