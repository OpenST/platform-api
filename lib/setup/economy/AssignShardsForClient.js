...
class AssignShardsForClient {
  ...
  async _decideShards() {
    ...
    if (oThis.preProvisioningInfo) {
      oThis.shardNumbersMap[shardConstant.user] = oThis.preProvisioningInfo.user;
      oThis.shardNumbersMap[shardConstant.device] = oThis.preProvisioningInfo.device;
      oThis.shardNumbersMap[shardConstant.recoveryAddress] = oThis.preProvisioningInfo.recoveryAddress;
      oThis.shardNumbersMap[shardConstant.session] = oThis.preProvisioningInfo.session;
    ...
    oThis.shardNumbersMap[shardConstant.user] = availableShards.user[oThis.clientId % availableShards.user.length];
    oThis.shardNumbersMap[shardConstant.device] =
      availableShards.device[oThis.clientId % availableShards.device.length];
    oThis.shardNumbersMap[shardConstant.recoveryAddress] =
      availableShards.recoveryAddress[oThis.clientId % availableShards.recoveryAddress.length];
    oThis.shardNumbersMap[shardConstant.session] =
  ...
  async _assignShards() {
    ...
    let ShardByToken = oThis.ic().getShadowedClassFor(coreConstants.icNameSpace, 'ShardByToken'),
