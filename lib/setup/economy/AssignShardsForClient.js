...
class AssignShardsForClient {
  ...
  async _decideShards() {
    ...
    if (oThis.preProvisioningInfo && oThis.preProvisioningInfo.token_users_shard_number) {
    ...
    oThis.shardNumbersMap[shardConstant.userEntityKind] =
      availableShards[shardConstant.userEntityKind][
        oThis.clientId % availableShards[shardConstant.userEntityKind].length
      ];
  }
