...
class AddPriceOracleToPricerRule {
   ...
   * @param {String} params.waitTillReceipt: should wait for receipt. NOT TO BE USED AS PART OF WORKFLOW.
   *
   * @constructor
   */
  constructor(params) {
  ...
  async _getPriceOracleContractAddr() {
    ...
    oThis.priceOracleContractAddr = cacheRsp.data['contract_address'];
  }
