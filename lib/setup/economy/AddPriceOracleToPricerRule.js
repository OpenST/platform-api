...
class AddPriceOracleToPricerRule {
  ...
  async _getPriceOracleContractAddr() {
    ...
    if (stakeCurrencyData.symbol === conversionRateConstants.OST) {
      oThis.priceOracleContractAddr =
        chainAddressCacheRsp.data[chainAddressConstants.auxOstToUsdPriceOracleContractKind].address;
    } else if (stakeCurrencyData.symbol === conversionRateConstants.USDC) {
      oThis.priceOracleContractAddr =
        chainAddressCacheRsp.data[chainAddressConstants.auxUsdcToUsdPriceOracleContractKind].address;
    } else {
      throw `unsupported stakeCurrencyData symbol ${stakeCurrencyData.symbol}`;
    }
  }
