'use strict';
/**
 * Deploy Token Holder Master Copy contract
 *
 * @module lib/setup/economy/DeployTokenHolderMaster
 */
...
class DeployTokenHolderMaster {
  ...
  async _deployContract() {
    ...
    let txOptions = {
      ...
      gas: contractConstants.deployTokenHolderMasterGas,
      value: contractConstants.zeroValue
    };

    let txObject = await openSTJsUserSetupHelper._deployTokenHolderMasterCopyRawTx(txOptions);
    ...
    let submitTxRsp = await new SubmitTransaction({
      ...
      pendingTransactionKind: pendingTransactionConstants.deployTokenHolderMasterCopyKind,
