...
class DeployPricerRule {
  ...
  async _fetchAndSetStakeCurrencyDetails() {
    ...
    oThis.stakeCurrencySymbol = stakeCurrencyCacheResponse.data[oThis.stakeCurrencyId].symbol;
  }
  ...
  async _deployContract() {
    ...
    Object.assign(oThis.responseData, {
      stakeCurrencySymbol: oThis.stakeCurrencySymbol,
