...
class DeployTokenOrganization {
  ...
  async _asyncPerform() {
    ...
    let params = {
      ...
      customSubmitTxParams: {
        ...
        pendingTransactionKind: pendingTransactionConstants.deployTokenOrganizationKind
      }
    };
  ...
  async _getDeployerAddr() {
    ...
    let associatedAuxChainId = '',
      deployerAddressKind = '';

    if (oThis.deployToChainKind === coreConstants.originChainKind) {
      associatedAuxChainId = 0;
      deployerAddressKind = chainAddressConstants.originDeployerKind;
    } else {
      associatedAuxChainId = oThis.deployChainId;
      deployerAddressKind = chainAddressConstants.auxDeployerKind;
    }
    ...
    return chainAddressesRsp.data[deployerAddressKind].address;
  }
