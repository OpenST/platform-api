...
class EconomySetupVerifier {
  ...
  async perform() {
    ...
    // TODO: TEMP CODE REVERT AFTER WE INTEGERATE MOSAIC.js
  ...
  async _validateGatewayComposer() {
    ...
    const dbSimpleTokenContractAddress = chainAddressesRsp.data[chainAddressConstants.stContractKind].address;
