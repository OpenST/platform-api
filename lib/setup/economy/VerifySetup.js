...
class EconomySetupVerifier {
  ...
  async perform() {
    ...
    console.log('1oThis.tokenAddresses', oThis.tokenAddresses);
  ...
  async _validateGatewayComposer() {
    ...
    console.log('oThis.tokenAddresses', oThis.tokenAddresses);
    ...
    console.log('gatewayComposerAddress', gatewayComposerAddress);

    await oThis._validateDeployedContract(gatewayComposerAddress, 'GatewayComposer', 'origin');
  }
  ...
  async _validateSetCoGateway() {
    ...
    let btContract = await oThis.originVerifiersHelper.getContractObj('UtilityBrandedToken', ubtContractAddress);
