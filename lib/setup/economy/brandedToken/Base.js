...
class DeployBrandedTokenBase {
  constructor(params) {
    ...
    oThis.originKindToAddressMap = null;
    oThis.auxKindToAddressMap = null;
  }
  ...
  async _setWeb3Instance() {
    const oThis = this;
    let chainEndpoint = oThis._configStrategyObject.chainRpcProvider(oThis.deployChainId, 'readWrite');
    oThis.web3Instance = web3Provider.getInstance(chainEndpoint).web3WsProvider;
  }
