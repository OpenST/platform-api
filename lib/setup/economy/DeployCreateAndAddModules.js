/**
 * Deploy Create And Add Modules
 *
 * @module lib/setup/economy/DeployCreateAndAddModules
 */
...
/**
 * Class for Create And Add Modules deployment
 *
 * @class
 */
class DeployCreateAndAddModules {
  /**
   * Constructor for Create And Add Modules deployment
   *
   * @param {Object} params
    ...
    return oThis._asyncPerform().catch(function(error) {
      if (responseHelper.isCustomResult(error)) {
        ...
        return responseHelper.error({
          internal_error_identifier: 'l_s_e_dcaam_1',
  ...
  async _deployContract() {
    ...
    let txOptions = {
      ...
      gas: contractConstants.deployCreateAndAddModulesGas,
      value: contractConstants.zeroValue
    };

    let txObject = await openStJsUserSetupHelper._deployCreateAndAddModulesRawTx();
    ...
    let submitTxRsp = await new SubmitTransaction({
      ...
      pendingTransactionKind: pendingTransactionConstants.deployCreateAndAddModulesKind,
