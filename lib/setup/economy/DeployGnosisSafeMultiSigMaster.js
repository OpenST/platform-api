'use strict';
/**
 * Deploy Gnosis-Safe Multi-sig Master Copy contract
 *
 * @module lib/setup/economy/DeployGnosisSafeMultiSigMaster
 */
...
/**
 * Class for Gnosis-Safe Multi-sig deployment
 *
 * @class
 */
class DeployGnosisSafeMultiSigMaster {
  /**
  ...
  async _deployContract() {
    ...
    let txObject = await openStJsUserSetupHelper._deployMultiSigMasterCopyRawTx(txOptions);
...
module.exports = DeployGnosisSafeMultiSigMaster;
