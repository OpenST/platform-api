...
class RegisterPricerRule {
  ...
  constructor(params) {
    ...
    oThis.pricerRuleName = ruleConstants.pricerRuleName;
  }
  ...
  async _setPricerRuleAddress() {
    ...
    oThis.pricerRuleAbi = JSON.stringify(ruleFetchRsp.data.abi);

    let ruleId = ruleFetchRsp.data.id;
