...
class PostAddCompanyWallet {
  ...
  async perform() {
    ...
    returnResponse.taskResponseData = returnResponse.taskResponseData || {};
    returnResponse.taskResponseData.tokenCompanyTokenHolderAddress = oThis.tokenCompanyTokenHolderAddress;
