...
const rootPrefix = '../../..',
  ...
  PreviousOwnersMapCache = require(rootPrefix + '/lib/cacheManagement/chain/PreviousOwnersMap');
...
class AddUserInUserWalletFactory {
  ...
  _initializeOpenStObject() {
    ...
    let gnosisSafeMasterCopy = oThis.tokenAddresses[tokenAddressConstants.gnosisSafeMultiSigMasterCopyContractKind],
  ...
  async _performAddUser() {
    ...
    let from = oThis.tokenAddresses[tokenAddressConstants.tokenUserOpsWorkerKind],
      to = oThis.tokenAddresses[tokenAddressConstants.userWalletFactoryContractKind];
  ...
  async _clearLinkedDeviceAddressCacheMap() {
    ...
    let previousOwnersMapObj = new PreviousOwnersMapCache({ userId: oThis.userId, tokenId: oThis.tokenId }),
