...
class RollbackUserActivation {
  ...
  async perform() {
    ...
    if (oThis.rollbackFailed) {
      return Promise.resolve(
        responseHelper.successWithData({
          ...
          taskResponseData: 'User Rollback Failed.'
        })
      );
    }
    ...
    return Promise.resolve(
      responseHelper.successWithData({
        ...
        taskResponseData: 'Token Holder deployment rollbacked.'
      })
    );
  }
  ...
  _rollbackDeviceStatus() {
    ...
    return deviceModelObj.updateItem(DeviceModel.sanitizeParamsToInsert(updateParams));
  }
  ...
  async _rollbackUser() {
    ...
    let response = await userModelObj.updateItem(UserModel.sanitizeParamsToInsert(updateParams), null, 'ALL_NEW');
