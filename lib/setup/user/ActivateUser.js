...
class ActivateUser {
  ...
  async _updateUserAddresses() {
    ...
    if (response.isFailure()) {
      ...
      console.log('=cacheParamsToSet======', cacheParamsToSet);
      ...
      console.log('==formattedCacheData======', formattedCacheData);

      await userDetailCacheObj._setCache(oThis.tokenHolderAddress, formattedCacheData);
    }
