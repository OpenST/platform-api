...
class SetupUsdcToken {
  ...
  constructor(originChainId, ethOwnerPrivateKey) {
    ...
    oThis.contractSymbol = stakeCurrencyConstants.USDC;
    oThis.contractCurrency = conversionRateConstants.USD;
    oThis.contractDecimals = coreConstants.USDC_CONVERSION_DECIMALS;
  }
  ...
  async _asyncPerform() {
    ...
    const originMaxGasPriceMultiplierWithBuffer = basicHelper.getOriginMaxGasPriceMultiplierWithBuffer(),
      amountForUsdcOwnerAddressForOneGwei = chainSetupFundingConfig.usdcContractOwnerEthConfig.fundAmount,
      amountForUsdcOwnerAddress = basicHelper
        .convertToLowerUnit(String(amountForUsdcOwnerAddressForOneGwei), coreConstants.ETH_DECIMALS)
