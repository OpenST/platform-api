...
class SetupUsdcToken {
  ...
  constructor(originChainId, ethOwnerPrivateKey) {
    ...
    oThis.contractName = contractConstants.usdcContractName;
    oThis.contractSymbol = conversionRateConstants.USDC;
  ...
  async _asyncPerform() {
    ...
    const originMaxGasPriceMultiplierWithBuffer = basicHelper.getOriginMaxGasPriceMultiplierWithBuffer(),
      ...
      amountForUsdcOwnerAddress = basicHelper
        .convertToLowerUnit(String(amountForUsdcOwnerAddressForOneGwei), coreConstants.ETH_CONVERSION_DECIMALS)
    ...
    // TODO @Santhosh - separate the mint step to a different executable
