...
class DeployMockToken {
  ...
  async asyncPerform() {
    ...
    await oThis.insertIntoChainAddress(mockTokenContractAddress);
   ...
   * @return {Promise<*>}
   */
  async insertIntoChainAddress(mockTokenContractAddress) {
    const oThis = this;

    await new ChainAddressModel().insertAddress({
      address: mockTokenContractAddress,
      associatedAuxChainId: 0,
      addressKind: chainAddressConstants.mockTokenContractKind,
      deployedChainId: oThis.originChainId,
