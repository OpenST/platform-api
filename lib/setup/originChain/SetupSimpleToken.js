...
const rootPrefix = '../../..',
  ...
  chainSetupFundingConfig = require(rootPrefix + '/lib/globalConstant/chainSetupFundingConfig'),
...
class SetupSimpleToken {
  ...
  async _asyncPerform() {
    ...
    const originMaxGasPriceMultiplierWithBuffer = basicHelper.getOriginMaxGasPriceMultiplierWithBuffer(),
      amountForSTOwnerAddressForOneGwei = chainSetupFundingConfig.stContractOwnerEthConfig.fundAmount,
      amountForSTAdminAddressForOneGwei = chainSetupFundingConfig.stContractAdminEthConfig.fundAmount,
      amountForSTOwnerAddress = basicHelper
        .convertToLowerUnit(String(amountForSTOwnerAddressForOneGwei), coreConstants.ETH_DECIMALS)
        .mul(basicHelper.convertToBigNumber(originMaxGasPriceMultiplierWithBuffer)),
      amountForSTAdminAddress = basicHelper
        .convertToLowerUnit(String(amountForSTAdminAddressForOneGwei), coreConstants.ETH_DECIMALS)
        .mul(basicHelper.convertToBigNumber(originMaxGasPriceMultiplierWithBuffer));
