...
class SetupSimpleToken {
  ...
  async _deploySimpleToken(simpleTokenOwnerAddr, simpleTokenOwnerPrivateKey) {
    ...
    const DeploySimpleToken = ic.getShadowedClassFor(coreConstants.icNameSpace, 'DeploySimpleToken'),
    ...
    return Promise.reject(new Error('deploySimpleToken failed.'));
  }
  ...
  async setSimpleTokenAdmin(
    ...
    const SetSimpleTokenAdmin = ic.getShadowedClassFor(coreConstants.icNameSpace, 'SetSimpleTokenAdmin'),
    ...
    return Promise.reject(new Error('setSimpleTokenAdmin failed.'));
  }
  ...
  async finalizeSimpleTokenAdmin(simpleTokenAdminAddr, simpleTokenAdminPrivateKey, simpleTokenContractAddress) {
    ...
    const FinalizeSimpleToken = ic.getShadowedClassFor(coreConstants.icNameSpace, 'FinalizeSimpleToken'),
    ...
    return Promise.reject(new Error('finalizeSimpleToken failed.'));
  }
