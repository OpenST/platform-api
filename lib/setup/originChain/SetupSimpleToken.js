...
require(rootPrefix + '/tools/chainSetup/origin/simpleToken/Deploy');
...
class SetupSimpleToken {
  ...
  async _asyncPerform() {
    ...
    let originMaxGasPriceMultiplierWithBuffer = basicHelper.getOriginMaxGasPriceMultiplierWithBuffer(),
