 ...
 *
 * @class RedemptionsById
 */
class RedemptionsById extends CacheManagementChainMultiBase {
  /**
...
InstanceComposer.registerAsShadowableClass(RedemptionsById, coreConstants.icNameSpace, 'RedemptionsById');
