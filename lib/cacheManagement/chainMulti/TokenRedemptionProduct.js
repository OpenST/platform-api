 ...
 */
class RedemptionProductCache extends CacheManagementChainMultiBase {
  /**
  ...
  _setCacheKeys() {
    ...
    for (let i = 0; i < oThis.ids.length; i++) {
      oThis.cacheKeys[oThis._cacheKeyPrefix() + 'c_trdp_id_' + oThis.ids[i].toLowerCase()] = oThis.ids[i];
    }
  }
...
InstanceComposer.registerAsShadowableClass(RedemptionProductCache, coreConstants.icNameSpace, 'RedemptionProductCache');
