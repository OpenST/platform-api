'use strict';
/**
 * Cache for fetching previous wallet addresses map by userId and tokenId. Extends base cache.
 *
...
require(rootPrefix + '/lib/device/PreviousWalletAddresses');
require(rootPrefix + '/lib/cacheManagement/chainMulti/TokenUserDetail');

/**
 * Class for fetching previous wallet addresses map by userId and tokenId.
 *
 * @class
 */
class PreviousOwnersMap extends ChainCacheManagementBase {
  /**
   * Constructor for fetching previous wallet addresses map by userId and tokenId.
   *
  ...
  async fetchDataFromSource() {
    ...
    if (oThis.multisigProxyAddress) {
      const PreviousWalletAddresses = oThis
          .ic()
          .getShadowedClassFor(coreConstants.icNameSpace, 'PreviousWalletAddresses'),
        previousOwnersObj = new PreviousWalletAddresses({ multiSigProxyAddress: oThis.multisigProxyAddress }),
