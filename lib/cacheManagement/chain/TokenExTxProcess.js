...
class TokenExTxProcess extends ChainCacheManagementBase {
  /**
  ...
  async fetchDataFromSource() {
    ...
    let exTxCronData = await new GetTokenWorkingProcess({ tokenId: oThis.tokenId }).perform();

    return responseHelper.successWithData(exTxCronData);
  }
}
