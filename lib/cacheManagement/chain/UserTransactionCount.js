...
/**
 * Cache for fetching user's transaction count
 *
 * @module lib/cacheManagement/chain/UserTransactionCount
 */
...
class UserTransactionCount extends BaseCacheManagement {
  /**
   * Constructor for fetching user's transaction count cache
   *
  ...
  constructor(params) {
    ...
    oThis.useObject = false; // setting useObject false
...
InstanceComposer.registerAsShadowableClass(UserTransactionCount, coreConstants.icNameSpace, 'UserTransactionCount');
