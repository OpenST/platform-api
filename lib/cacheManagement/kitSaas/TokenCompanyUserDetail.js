 ...
 * @class
 */
class TokenCompanyUserDetailsByTokenIdCache extends BaseCacheManagement {
  /**
   * Constructor for token company user details cache
   *
...
module.exports = TokenCompanyUserDetailsByTokenIdCache;
