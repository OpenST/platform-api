...
class Rule extends BaseKitSaasMultiCacheManagement {
   ...
   * @param params.ruleTokenIdNames {Array} - ruleTokenId-Name['2_Pricer','3_TR']
   *
   * @constructor
   */
  constructor(params) {
  ...
  _setCacheKeys() {
    ...
    for (let i = 0; i < oThis.ruleTokenIdNames.length; i++) {
      oThis.cacheKeys[oThis._cacheKeyPrefix() + 'cm_ksm_r_' + oThis.ruleTokenIdNames[i]] = oThis.ruleTokenIdNames[i];
    }
  }
