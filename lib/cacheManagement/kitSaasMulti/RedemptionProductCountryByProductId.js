...
class RedemptionProductCountryByProductId extends BaseKitSaasMultiCacheManagement {
   ...
   *
   * @param cacheMissRedemptionProductIds
   * @returns {Promise<void>}
   * @private
   */
  async _fetchDataFromSource(cacheMissRedemptionProductIds) {
    return new RedemptionProductCountryModel().fetchDetailsByProductIds(cacheMissRedemptionProductIds);
  }
}
