/**
 * Cache for redemption product countries by country ISO codes.
 *
...
class RedemptionProductCountryByCountryIso extends BaseKitSaasMultiCacheManagement {
   ...
   * @param {array<string/number>} params.countryIsoCodes
   *
   ...
   *
   * @param {array<string/number>} cacheMissCountryIsoCodes
   *
   * @returns {Promise<*>}
   * @private
   */
