...
class PendingWebhooks extends CacheManagementSharedBase {
  ...
  async fetchDataFromSource() {
    ...
    const dataToSet = {
      client_id: finalResponse.clientId,
      event_uuid: finalResponse.eventUuid,
      topic: finalResponse.topic,
      extra_data: finalResponse.extraData || null,
      status: finalResponse.status,
      retry_count: finalResponse.retry_count,
      last_attempted_at: finalResponse.last_attempted_at
    };
