...
class FlushSharedMemcached {
  async clearCache(key) {
    ...
    try {
      ...
      return responseHelper.successWithData({ successEndpoint: successEndpoint, failedEndpoint: failedEndpoint });
    } catch (err) {
      //Format the error
      logger.error('lib/cacheManagement/shared/FlushSharedMemcached.js:clearCache:wait inside catch ', err);
  ...
  _clear(endPoint, key) {
    ...
    return new Promise(function(onResolve, onReject) {
      try {
        ...
        //Format the error
        logger.error('lib/cacheManagement/shared/FlushSharedMemcached.js:_clear:wait inside catch ', err);
        return onResolve(
          responseHelper.error({
