...
class AuthenticateApiByApiKeySecret extends Base {
  ...
  async _validateParams() {
    ...
    logger.debug('apiAuthentication: ByApiKeySecretStep: 1');
  ...
  async _validateSignature() {
    ...
    logger.debug('apiAuthentication: ByApiKeySecretStep: 3');
    ...
    logger.debug('apiAuthentication: ByApiKeySecretStep: 4');
    ...
    logger.debug('apiAuthentication: ByApiKeySecretStep: 5');
