...
class Factory {
  ...
  async _asyncPerform() {
    ...
    if (response.isSuccess()) {
      response.data['appValidatedApiName'] = matchData.api_name;
    }
    return response;
  }
  ...
  _validateParams() {
    ...
    if (paramErrors.length > 0) {
      return oThis._paramValidationError('l_vas_f_3', paramErrors);
    }
    ...
    if (oThis.requestMethod === apiSignature.getRequestKind) {
      ...
      return oThis._apiError('l_vas_f_2', 'resource_not_found');
    }
