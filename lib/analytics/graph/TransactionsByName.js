  ...
  prepareData(allTimeSeries, queryResponse) {
    ...
    for (let i = 0; i < queryResponse.length; i++) {
      let dataMap = {
        ...
        token_transfers: queryResponse[i].totalTransfers,
        token_transactions: queryResponse[i].totalTransactions,
        token_ost_volume: queryResponse[i].totalVolume
      };
    ...
    responseHash['transactions_by_name'] = resultArray;
    responseHash['meta'] = {
