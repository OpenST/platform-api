  ...
  async getFor(chainIds) {
    ...
    if (chainIds.length > 1) {
      ...
      for (let chainId in result) {
        ...
        console.log('result[configStrategyConstants.constants]--------', res[configStrategyConstants.constants]);
        console.log(
          'result[configStrategyConstants.constants].originChainId--------',
          res[configStrategyConstants.constants].originChainId
        );
