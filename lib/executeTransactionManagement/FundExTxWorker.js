...
const fundingConfig = {
  [tokenAddressConstants.txWorkerAddressKind]: '0.0000001' //this is approx tx fee for PR transfer for 1 address
};
      ...
      if (tokenTxWorkerCurrentBalance.lt(tokenTxWorkerMinimumBalance.mul(minimumNoOfExecuteTransaction))) {
        let params = {
          ...
          amountInWei: basicHelper
            .convertToWei(tokenTxWorkerMinimumBalance.mul(totalNoOfExecuteTransaction)) //TODO-Funding
            .toString(10)
        };
