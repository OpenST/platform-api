...
class AssociateWorker {
  ...
  async _associateAvailableWorker() {
    ...
    let FundExTxWorker = oThis.ic().getShadowedClassFor(coreConstants.icNameSpace, 'FundExTxWorker'),
