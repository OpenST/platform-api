...
class AcceptStakeByWorker extends Base {
  ...
  async _performAcceptStake() {
    ...
    let btStakeHelper = new BrandedToken.Helpers.StakeHelper(
      ...
      tempResp = await btStakeHelper._getGCStakeRequestRawTx(oThis.requestStakeHash, workerWeb3Instance);

    console.log('Temp Response', tempResp);
    ...
    // console.log("Staker Nonce: ", stakerBtNonce);
    // console.log("Accept Stake Request: ", oThis);
