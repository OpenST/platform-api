...
class Stake extends Base {
  ...
  async _getStakerNonceFromGateway() {
    ...
    oThis.stakerNonce = await oThis._stakeHelperObject.getNonce(oThis.stakerAddress, oThis.originWeb3, oThis.gatewayContract);
  }
  ...
  async _performStake() {
    ...
    let gasPrice = '0',
      gasLimit = '5000000',
      txObject = oThis._stakeHelperObject._stakeRawTx(oThis.amount,
        oThis.beneficiary, gasPrice, gasLimit, oThis.stakerNonce,
        oThis.hashLock, {}, oThis.originWeb3, oThis.gatewayContract, oThis.stakerAddress);
