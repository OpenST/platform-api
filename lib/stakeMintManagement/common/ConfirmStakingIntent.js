...
class ConfirmStakingIntent extends Base {
  /**
   * @constructor
   *
   * @param params {Object}
  ...
  async _asyncPerform() {
    ...
    let response = await oThis._confirmStakeIntent();
  ...
  async _getGetwayOutboxStorageProof() {
    ...
    let merkleProof = new MerkleProof({
      ...
      messageHash: oThis.stakeMessageHash
    });
...
module.exports = ConfirmStakingIntent;
