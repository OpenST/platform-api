...
class CommonValidator {
  ...
  static validateMetaPropertyForInsertion(object) {
    ...
    if (object.hasOwnProperty('details') && object['details'].length > 150) {
      return false;
    }
  ...
  static validateMetaPropertyName(name) {
    if (typeof name !== 'string' || !CommonValidator.validateAlphaNumericString(name)) {
      return false;
    }
    return true;
  }
  ...
  static validateMetaPropertyDetails(details) {
    ...
    return /^[0-9a-z\s\-_]{1,}$/.test(details);
  }
