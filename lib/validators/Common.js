...
class CommonValidator {
  ...
  static validateDdbNextPagePayload(variable) {
    if (typeof variable !== 'object') {
      return false;
    } else if (typeof variable['lastEvaluatedKey'] !== 'string') {
      return false;
    } else {
      return CommonValidator.validateLastEvaluatedKey(variable['lastEvaluatedKey']);
    }
  }

  static validateLastEvaluatedKey(key) {
    //TODO: Implement
    return true;
  }
}
