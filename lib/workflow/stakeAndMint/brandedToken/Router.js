  ...
  async _performStep() {
    ...
    switch (oThis.stepKind) {
      ...
      case workflowStepConstants.approveGatewayComposerTrx:
        ...
        oThis.requestParams.pendingTransactionKind = pendingTransactionConstants.approveGatewayComposerKind;
      ...
      case workflowStepConstants.recordRequestStakeTx:
        ...
        oThis.requestParams.pendingTransactionKind = pendingTransactionConstants.requestStakeKind;
        return new RecordStakerTx(oThis.requestParams).perform(oThis._currentStepPayloadForPendingTrx());
