...
class BtStakeAndMintRouter extends WorkflowRouterBase {
  ...
  _uniqueWorkflowHash() {
    ...
    let uniqueStr = oThis.requestParams.originChainId + '_';

    if (oThis.requestParams.approveTransactionHash && oThis.requestParams.requestStakeTransactionHash) {
      uniqueStr += oThis.requestParams.approveTransactionHash + '_';
      uniqueStr += oThis.requestParams.requestStakeTransactionHash;
    } else {
      uniqueStr = oThis.requestParams.stakerAddress + '_';
