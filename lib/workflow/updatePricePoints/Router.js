...
require(rootPrefix + '/lib/updatePricePoints/UpdatePricePointsInBlockScanner');
...
class UpdatePricePointsRouter extends AuxWorkflowRouterBase {
  ...
  async _performStep() {
    ...
    switch (oThis.stepKind) {
      ...
      // Set price points in block scanner.
      case workflowStepConstants.updatePricePointsInBlockScanner: {
        logger.info('========== UpdatePricePointsInBlockScanner ==========');

        const UpdatePricePointsInBlockScanner = ic.getShadowedClassFor(
          coreConstants.icNameSpace,
        ...
        return new UpdatePricePointsInBlockScanner({
          chainId: oThis.requestParams.chainId,
          stakeCurrency: oThis.requestParams.currentErc20Value.baseCurrency,
          quoteCurrency: oThis.requestParams.currentErc20Value.quoteCurrency,
          conversionRate: oThis.requestParams.currentErc20Value.conversionRate
        }).perform();
      }
