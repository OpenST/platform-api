...
class UserSetupRouter extends AuxWorkflowRouterBase {
  ...
  async _performStep() {
    ...
    switch (oThis.stepKind) {
      ...
      case workflowStepConstants.addSessionAddresses: {
        // Send users activation initiate topic webhook to preProcessor.
        const preProcessorWebhookDetails = oThis.preProcessorWebhookDetails(
          webhookSubscriptionsConstants.usersActivationInitiateTopic
        );
      ...
      case workflowStepConstants.markSuccess: {
        ...
        const preProcessorWebhookDetails = oThis.preProcessorWebhookDetails(
          webhookSubscriptionsConstants.usersActivationSuccessTopic
        );
      ...
      case workflowStepConstants.markFailure: {
        ...
        const preProcessorWebhookDetails = oThis.preProcessorWebhookDetails(
          webhookSubscriptionsConstants.usersActivationFailureTopic
        );
   ...
   * @returns {{chainId: *, payload: {webhookKind: string, clientId: number/string, tokenId: number/string, userId: string}}}
   */
