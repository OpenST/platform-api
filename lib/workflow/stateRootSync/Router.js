...
//Rachin:
/*
 * It is very complicated for outside world to decide what is sourceChainId & destinationChainId.
 * Instead, StateRootSyncRouter should decide sourceChainId & destinationChainId
 * This can be done by asking for 'intent' or 'syncKind' which can be 
 * static strings/numbers of StateRootSyncRouter class. E.g.:
 * 
 * StateRootSyncRouter.INTENTS = {
 *   "ORIGIN_TO_AUX" : "ORIGIN_TO_AUX",
 *   "AUX_TO_ORIGIN" : "AUX_TO_ORIGIN"
 * }
 *
 * The outside world can read and pass these constants to StateRootSyncRouter in params 
 * and still speaks in terms of aux and origin chianIds.
 * StateRootSyncRouter can then decide on what sourceChainId & destinationChainId should be.
*/
