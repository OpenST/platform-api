 ...
 *
 * @module lib/workflow/grantStakeCurrency/Router
 */
...
const rootPrefix = '../../..',
  ...
  grantEthOstStepsConfig = require(rootPrefix + '/lib/workflow/grantStakeCurrency/stepsConfig'),
...
class GrantEthOstRouter extends WorkflowRouterBase {
   ...
   */
  constructor(params) {
    params['workflowKind'] = workflowConstants.grantStakeCurrencyKind; // Assign workflowKind.
    super(params);
