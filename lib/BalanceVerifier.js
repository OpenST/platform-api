...
class BalanceVerifier {
  ...
  async _getDataFromEs() {
    ...
    let esSearchResponse = await oThis._queryDataFromEs(oThis.timeStamp);
  ...
  async getFinalMismatchAddresses(
    ...
    addressesToCheck.concat(pessimisticSettledBalanceMismatchAddresses);
    addressesToCheck.concat(settledBalanceMismatchAddresses);
    addressesToCheck.concat(unsettledDebitsNotZeroAddresses);
