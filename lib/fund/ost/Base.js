  ...
  async _fundAddress(toAddress) {
    ...
    let encodedABI = simpleTokenContractObj.methods
      ...
      ostTransferParams = {
        ...
        data: encodedABI,
        nonce: nonce,
        gas: 25000 // ToDO Check the exact gas limit
      };
    ...
    await oThis.originWeb3.eth
      ...
      .then(function(response) {
        ...
        console.log('response--------- From ost base', response);
        return Promise.resolve(responseHelper.successWithData({ transactionHash: response.transactionHash }));
      })
