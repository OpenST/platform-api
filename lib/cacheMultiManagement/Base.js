 ...
 */
const rootPrefix = '../..',
  InstanceComposer = require(rootPrefix + '/instanceComposer'),
  responseHelper = require(rootPrefix + '/lib/formatter/response'),
  logger = require(rootPrefix + '/lib/logger/customConsoleLogger');

// Following require(s) for registering into instance composer
require(rootPrefix + '/lib/providers/sharedMemcached');
...
InstanceComposer.registerShadowableClass(BaseMultiCacheManagement, 'BaseMultiCacheManagement');
