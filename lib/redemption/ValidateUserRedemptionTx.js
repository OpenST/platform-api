...
class ValidateUserRedemptionTx {
  ...
  async perform() {
    ...
    // TODO - redemption - low cost validations here - validate all the keys of oThis.redemptionDetails for data type checks.

    // TODO - redemption - use the token fetched in from user service
