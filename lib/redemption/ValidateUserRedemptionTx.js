...
class ValidateUserRedemptionTx {
  ...
  async _validateTokenProduct() {
    ...
    const cacheFetchRsp = await new TokenRedemptionProductIdsByTokenIdCache({ tokenId: oThis.tokenId }).fetch(),
      redeemableProducts = cacheFetchRsp.data.redemptionProductIds;
