...
class ExecuteTokenHolderRedemption extends RedeemBase {
  ...
  constructor(params) {
    ...
    oThis.tokenHolderContractAddress = null;
  ...
  async _fetchTokenContracts() {
    ...
    oThis.tokenHolderContractAddress = addressesResp.data[tokenAddressConstants.tokenHolderMasterCopyContractKind];
  }
  ...
  async _getExecutableTxData() {
    ...
    console.log('executeRedemptionRawTxInput', [
      oThis.tokenHolderContractAddress,
      oThis.coGatewayContractAddress,
