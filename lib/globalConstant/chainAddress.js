...
const chainAddress = {
  ...
  auxOstToUsdPriceOracleContractKind: 'auxOstToUsdPriceOracleContract',
  auxUsdcToUsdPriceOracleContractKind: 'auxUsdcToUsdPriceOracleContract',
  auxPriceOracleContractWorkerKind: 'auxPriceOracleContractWorker',
  originStableCoinDeployerKind: 'originStableCoinDeployer',
...
// Addresses with enums 3,4,5, 46 are removed and moved to stake currencies table. Can re-use them.
chainAddress.kinds = {
  ...
  '42': chainAddress.auxOstToUsdPriceOracleContractKind,
  '43': chainAddress.auxPriceOracleContractWorkerKind,
  '44': chainAddress.originStableCoinDeployerKind,
  '45': chainAddress.auxUsdcToUsdPriceOracleContractKind
};
