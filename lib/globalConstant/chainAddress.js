...
const chainAddress = {
  ...
  priceOracleContractKind: 'priceOracleContract',
  priceOracleOpsAddressKind: 'priceOracleOpsAddress',
...
chainAddress.kinds = {
  ...
  '24': chainAddress.priceOracleContractKind,
  '25': chainAddress.priceOracleOpsAddressKind
};
...
chainAddress.uniqueKinds = [
  ...
  chainAddress.granterKind,
  chainAddress.priceOracleContractKind,
  chainAddress.priceOracleOpsAddressKind
];
