...
const cronProcesses = {
    ...
    economyAggregator: 'economyAggregator',
  ...
  kind = {
    ...
    '1': cronProcesses.blockParser,
    '2': cronProcesses.transactionParser,
    '3': cronProcesses.blockFinalizer,
    '4': cronProcesses.economyAggregator
  },
  status = {
