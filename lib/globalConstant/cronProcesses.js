...
class CronProcesses {
  ...
  get blockParserRestartInterval() {
    return 30 * 60 * 1000;
  }

  get transactionParserRestartInterval() {
    return 30 * 60 * 1000;
  }

  get finalizerRestartInterval() {
    return 30 * 60 * 1000;
  }

  get aggregatorRestartInterval() {
    return 30 * 60 * 1000;
  }

  get balanceSettlerRestartInterval() {
    return 30 * 60 * 1000;
  }
