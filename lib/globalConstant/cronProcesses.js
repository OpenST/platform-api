...
class CronProcesses {
  ...
  get fundByChainOwnerOriginChainSpecific() {
    return 'fundByChainOwnerOriginChainSpecific';
  }

  get fundByChainOwnerAuxChainSpecific() {
    return 'fundByChainOwnerAuxChainSpecific';
  }
