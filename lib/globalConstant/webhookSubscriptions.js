...
class WebhookSubscriptionsConstants {
  ...
  get topics() {
    ...
    topics = {
      ...
      '7': oThis.devicesAuthorizedTopic,
      '8': oThis.devicesUnauthorizedTopic,
      '9': oThis.devicesInitiateRecoveryTopic,
      '10': oThis.devicesRecoveryAbortedTopic,
      '11': oThis.devicesRecoverySuccessTopic,
