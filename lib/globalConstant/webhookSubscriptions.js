...
class WebhookSubscriptionsConstants {
  ...
  // Redemption topic start.

  get redemptionInitiatedTopic() {
    return 'redemptions/initiate';
  }

  get redemptionAcceptedTopic() {
    return 'redemptions/accept';
  }

  get redemptionFailedTopic() {
    return 'redemptions/failure';
  }

  get redemptionCancelledTopic() {
    return 'redemptions/cancel';
  }

  get redemptionFulfilledTopic() {
    return 'redemptions/fulfill';
  }

  // Redemption topic end.
  ...
  get pricePointsTopic() {
    return 'price_points';
  }

  get userRedemptionsTopic() {
  ...
  get topics() {
    ...
    topics = {
      ...
      '4': oThis.transactionsMinedTopic,
      ...
      '70': oThis.redemptionInitiatedTopic,
      '71': oThis.redemptionAcceptedTopic,
      '72': oThis.redemptionFailedTopic,
      '73': oThis.redemptionCancelledTopic,
      '74': oThis.redemptionFulfilledTopic
    };
  ...
  get webhookQueueTopicName() {
    ...
    webhookQueueTopics = {
      ...
      [oThis.transactionsMinedTopic]: oThis.transactionsTopic,
      ...
      [oThis.usdPricePointUpdatedTopic]: oThis.pricePointsTopic,
      [oThis.eurPricePointUpdatedTopic]: oThis.pricePointsTopic,
      [oThis.gbpPricePointUpdatedTopic]: oThis.pricePointsTopic,

      [oThis.redemptionInitiatedTopic]: oThis.userRedemptionsTopic,
      [oThis.redemptionAcceptedTopic]: oThis.userRedemptionsTopic,
      [oThis.redemptionFailedTopic]: oThis.userRedemptionsTopic,
      [oThis.redemptionCancelledTopic]: oThis.userRedemptionsTopic,
      [oThis.redemptionFulfilledTopic]: oThis.userRedemptionsTopic
    };
