...
class WorkflowStepConstants {
  ...
  get btRequestStakeHandle() {
    return 'btRequestStakeHandle';
  }

  get checkRequestStakeTxStatus() {
    return 'checkRequestStakeTxStatus';
  }
  ...
  get btApproveTxHandle() {
    return 'btApproveTxHandle';
  }

  get checkApproveTxStatus() {
    return 'checkApproveTxStatus';
  }
