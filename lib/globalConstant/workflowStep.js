...
class WorkflowStepConstants {
  ...
  get stPrimeProveGateway() {
    return 'stPrimeProveGateway';
  }

  get stPrimeConfirmStakeIntent() {
    return 'stPrimeConfirmStakeIntent';
  }

  get stPrimeProgressStake() {
    return 'stPrimeProgressStake';
  }

  get stPrimeProgressMint() {
    return 'stPrimeProgressMint';
  }
