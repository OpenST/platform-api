...
class WorkflowStepConstants {
  ...
  get addUsdPriceOracleInPricerRule() {
    return 'addUsdPriceOracleInPricerRule';
  }

  get addEurPriceOracleInPricerRule() {
    return 'addEurPriceOracleInPricerRule';
  }

  get addGbpPriceOracleInPricerRule() {
    return 'addGbpPriceOracleInPricerRule';
  }

  get verifyAddUsdPriceOracleInPricerRule() {
    return 'verifyAddUsdPriceOracleInPricerRule';
  }

  get verifyAddEurPriceOracleInPricerRule() {
    return 'verifyAddEurPriceOracleInPricerRule';
  }

  get verifyAddGbpPriceOracleInPricerRule() {
    return 'verifyAddGbpPriceOracleInPricerRule';
  }

  get setUsdAcceptedMarginInPricerRule() {
    return 'setUsdAcceptedMarginInPricerRule';
  }
  get verifySetUsdAcceptedMarginInPricerRule() {
    return 'verifySetUsdAcceptedMarginInPricerRule';
  }

  get setEurAcceptedMarginInPricerRule() {
    return 'setEurAcceptedMarginInPricerRule';
  }
  get verifySetEurAcceptedMarginInPricerRule() {
    return 'verifySetEurAcceptedMarginInPricerRule';
  }

  get setGbpAcceptedMarginInPricerRule() {
    return 'setGbpAcceptedMarginInPricerRule';
  }
  get verifySetGbpAcceptedMarginInPricerRule() {
    return 'verifySetGbpAcceptedMarginInPricerRule';
  }
  ...
  get recordOrSubmitRequestStakeTx() {
    return 'recordOrSubmitRequestStakeTx';
  }
  ...
  get recordOrSubmitApproveGCTx() {
    return 'recordOrSubmitApproveGCTx';
  }
  ...
  // Grant Eth and Stake currency steps start.
  get grantEthStakeCurrencyInit() {
    return 'grantEthStakeCurrencyInit';
  }
  ...
  get grantStakeCurrency() {
    return 'grantStakeCurrency';
  }

  get verifyGrantStakeCurrency() {
    return 'verifyGrantStakeCurrency';
  }
  // Grant Eth and Stake currency steps finish.
  ...
  get updatePricePointsInBlockScanner() {
    return 'updatePricePointsInBlockScanner';
  }
