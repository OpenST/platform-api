...
const chainSetupLogs = {
  ...
  deployMessageBusLibKind: 'deployMessageBusLib',
  deployGatewayLibKind: 'deployGatewayLib',
  auxChainKind: 'aux',
...
chainSetupLogs.stepKinds = {
  ...
  '9': chainSetupLogs.deployMessageBusLibKind,
  '10': chainSetupLogs.deployGatewayLibKind
};
