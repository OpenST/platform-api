...
const chainSetupLogs = {
  ...
  configureMinterBaseContractStepKind: 'configureMinterBaseContract',
  mintBaseContractStepKind: 'mintBaseContract',
...
chainSetupLogs.stepKinds = {
  ...
  '14': chainSetupLogs.configureMinterBaseContractStepKind,
  '15': chainSetupLogs.mintBaseContractStepKind
};
...
chainSetupLogs.invertedStatuses = util.invert(chainSetupLogs.status);
