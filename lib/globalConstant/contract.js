...
class Contract {
  ...
  get gatewayComposerGasPrice() {
    return '0';
  }

  get gatewayComposerGasLimit() {
    return '0';
  }
  ...
  get companyTokenHolderSessionCount() {
    let basicHelper = require(rootPrefix + '/helpers/basic');

    if (basicHelper.isDevelopment()) return 10;
    return 300;
  }
