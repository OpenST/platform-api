...
class Contract {
  ...
  get deployUsdcTokenGas() {
    return 4980000; // 3319590
  }

  get initializeUsdcTokenGas() {
    return 280000; // 184353
  }
  ...
  get usdcMintAmountInLowestUnit() {
  ...
  // Redeem and unstake gas constants
  ...
  get redeemStPrimeGas() {
    return 5000000;
  }

  get proveCoGatewayOnOriginGas() {
    return 7000000;
  }

  get confirmRedeemIntentOnOriginGas() {
    return 7000000;
  }

  get progressRedeemGas() {
    return 200000;
  }

  get progressUnstakeGas() {
    return 200000; // 88842
  }

  get executeBTredemptionGas() {
    return 5000000;
  }
  ...
  get acceptanceMargin() {
    return '1000000000000000000'; // 1 USD in wei(Atto)
  }
  ...
  get companyTokenHolderSessionSpendingLimitInOstWei() {
    return '10000000000000000000000'; // 10000
  }

  get companyTokenHolderSessionSpendingLimitInUsdcWei() {
    return '10000000000'; // 10000 //TODO: Ask PM for Value here
  }
  ...
  get usdcContractName() {
    return 'PAX';
    // The contract name is written intentionally so to match with the name of actual contract deployed on Mainnet.
  }

  //TODO: Move value of USDC to a single constant ref: lib/globalConstant/conversionRates.js
  get usdcContractSymbol() {
    return 'PAX';
  }
  //TODO: Move value of USD to a single constant ref: lib/globalConstant/conversionRates.js
  get usdcContractCurrency() {
    return 'USD';
  }

  // get usdcContractDecimals() {
  //   return 6;
  // }
