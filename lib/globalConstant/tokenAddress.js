...
class TokenAddressConstants {
  ...
  get tokenRulesContract() {
    return 'tokenRulesContract';
  }

  get tokenHolderMasterCopyContract() {
    return 'tokenHolderMasterCopyContract';
  }

  get userWalletFactoryContract() {
    return 'userWalletFactoryContract';
  }

  get gnosisSafeMultiSigMasterCopyContract() {
  ...
  get uniqueKinds() {
    ...
    return [
      ...
      oThis.tokenRulesContract,
      oThis.tokenHolderMasterCopyContract,
      oThis.userWalletFactoryContract,
      oThis.gnosisSafeMultiSigMasterCopyContract
    ];
  }
}
