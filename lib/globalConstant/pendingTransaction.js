/**
 * Module to declare constants for pending transactions.
 *
...
const pendingTransaction = {
  ...
  grantStakeCurrencyKind: 'grantStakeCurrency',
  ...
  redeemStPrimeKind: 'redeemStPrime',
  stPrimeApproveCoGatewayKind: 'stPrimeApproveCoGateway',
  wrapStPrimeAsBTKind: 'wrapStPrimeAsBT',
  tokenHolderRedemptionKind: 'tokenHolderRedemptionKind',
  proveCoGatewayOnGatewayKind: 'proveCoGatewayOnGateway',
  confirmRedeemIntentKind: 'confirmRedeemIntent',
  progressRedeemKind: 'progressRedeem',
  progressUnstakeKind: 'progressUnstake',
  updatePricePointsKind: 'updatePricePoints'
};
...
pendingTransaction.kinds = {
  ...
  '44': pendingTransaction.grantStakeCurrencyKind,
  ...
  '58': pendingTransaction.wrapStPrimeAsBTKind,
  '59': pendingTransaction.stPrimeApproveCoGatewayKind,
  '60': pendingTransaction.redeemStPrimeKind,
  '61': pendingTransaction.tokenHolderRedemptionKind,
  '62': pendingTransaction.proveCoGatewayOnGatewayKind,
  '63': pendingTransaction.confirmRedeemIntentKind,
  '64': pendingTransaction.progressRedeemKind,
  '65': pendingTransaction.progressUnstakeKind,

  '66': pendingTransaction.updatePricePointsKind
};
