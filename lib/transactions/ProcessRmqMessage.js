...
class ProcessRmqExecuteTxMessage {
  ...
  async _validateParams() {
    ...
    if (
      ...
      !CommonValidators.validateInteger(oThis.transactionMetaId) ||
  ...
  async _markAsSubmitted() {
    ...
    return new TransactionMetaModel().releaseLockAndMarkStatus(metaParams);
  }
  ...
  async _revertOperations(response) {
    ...
    return new TransactionMetaModel().releaseLockAndMarkStatus(metaUpdateParams);
  }
