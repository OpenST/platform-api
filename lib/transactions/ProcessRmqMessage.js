...
class ProcessRmqExecuteTxMessage {
  ...
  async _validateParams() {
    ...
    if (
      !CommonValidators.isVarNull(oThis.transactionUuid) ||
      !CommonValidators.isVarNull(oThis.transactionMetaId) ||
      !CommonValidators.isVarNull(oThis.fromAddress) ||
      !CommonValidators.isVarNull(oThis.fromAddressNonce)
    ) {
  ...
  async _markAsSubmitted() {
    ...
    await new TransactionMetaModel().releaseLockAndMarkStatus(metaParams);
  }
