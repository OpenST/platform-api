...
class NonceGetForSession extends GetNonceBase {
  ...
  async _getNonceFromChainAndSetCache() {
    ...
    if (getSessionNonceQueryRsp.isSuccess() && !CommonValidators.isVarNull(getSessionNonceQueryRsp.data.nonce)) {
    ...
    let ic = new InstanceComposer(oThis.configStrategy),
      params = {
        ...
        chainWsProviders: oThis.chainWsProviders,
        chainRpcProviders: oThis.chainRpcProviders
      },
