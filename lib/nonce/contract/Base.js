...
class Base {
   ...
   * @param {Object} [params.web3Providers] - web3Providers (Optional Parameter)
   *
   */
  constructor(params) {
    const oThis = this;
    ...
    oThis.web3Providers = params.web3Providers;
  ...
  async _fetchWeb3Instance() {
    ...
    oThis.web3Instance = web3Provider.getInstance(oThis.web3Providers[0]).web3WsProvider;
  }
