...
class Base {
  ...
  constructor(params) {
    ...
    oThis.cronsPerEnv = cronProcessesConstants.cronsPerEnv;
    oThis.cronsPerChain = cronProcessesConstants.cronsPerChain;
  }
  ...
  /**
   * Check if cron kind exists in the same environment again.
   *
   * @param {String} chainIdKey
   * @param {Number/String} chainIdValue
   *
   * @return {Promise<never>}
   */
  async checkForExistingCronPerEnv(chainIdKey, chainIdValue) {
    const oThis = this;
