 ...
 *
 * @module lib/cronProcess/FundByMasterInternalFunderAuxChainSpecificTokenFunderAddresses
 */
 ...
 * @class
 */
class FundByMasterInternalFunderAuxChainSpecificTokenFunderAddresses extends CronProcessBase {
  /**
  ...
  async validate() {
    ...
    if (!CommonValidators.validateInteger(oThis.originChainId)) {
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_co_fbmifaxstfa_1',
    ...
    if (!CommonValidators.validateInteger(oThis.auxChainId)) {
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_co_fbmifaxstfa_2',
          api_error_identifier: '',
          debug_options: {}
        })
      );
...
module.exports = FundByMasterInternalFunderAuxChainSpecificTokenFunderAddresses;
