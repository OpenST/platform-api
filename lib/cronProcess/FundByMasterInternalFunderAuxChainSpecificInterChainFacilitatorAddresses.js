 ...
 *
 * @module lib/cronProcess/FundByMasterInternalFunderAuxChainSpecificInterChainFacilitatorAddresses
 */
 ...
 * @class
 */
class FundByMasterInternalFunderAuxChainSpecificInterChainFacilitatorAddresses extends CronProcessBase {
  /**
  ...
  async validate() {
    ...
    if (!CommonValidators.validateInteger(oThis.originChainId)) {
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_co_fbmifacsicfa_1',
    ...
    if (!CommonValidators.validateInteger(oThis.auxChainId)) {
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_co_fbmifacsicfa_2',
          api_error_identifier: '',
          debug_options: {}
        })
      );
...
module.exports = FundByMasterInternalFunderAuxChainSpecificInterChainFacilitatorAddresses;
