...
class WebhookEventFormatter {
  ...
  _createWebhookEntity() {
    ...
    oThis.webhookEntity = {
      ...
      version: webhookEndpointConstants.apiVersions[oThis.rawWebhook.apiVersion], // This is webhook response data version, it is expected to with API verison which is v2.0 at the time of writing this document.
      data: {}
    };
  }
