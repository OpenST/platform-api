...
class UserRedemptionFormatter {
   ...
   * @param {String} params.redemptionProductId
  ...
  perform() {
    ...
    if (
      ...
      !oThis.params.hasOwnProperty('transactionId') ||
    ...
    formattedTransactionData.redemption_product_id = oThis.params.redemptionProductId;
