...
class RuleFormatter {
  ...
  perform() {
    ...
    formattedRulesData['id'] = Number(oThis.params.id);
    formattedRulesData['token_id'] = Number(oThis.params.tokenId);
    ...
    formattedRulesData['updated_timestamp'] = Number(basicHelper.dateToSecondsTimestamp(oThis.params.updatedTimestamp));
