...
class TokenFormatter {
  ...
  perform() {
    ...
    formattedTokenData['conversion_factor'] = oThis.params.tokenDetails.conversionFactor;
    formattedTokenData['updated_timestamp'] = oThis.params.tokenDetails.updatedTimestamp;
    ...
    auxChainDetails['company_token_holders'] = [];
