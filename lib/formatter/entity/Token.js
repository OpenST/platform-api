...
class TokenFormatter {
  ...
  perform() {
    ...
    formattedTokenData['circulating_supply'] = oThis.params.economyDetails.circulatingSupply || '0';
    ...
    auxChainDetails['company_uuids'] = oThis.params.companyUuids;
    ...
    console.log('\n\n\nformattedTokenData-----------', JSON.stringify(formattedTokenData));
