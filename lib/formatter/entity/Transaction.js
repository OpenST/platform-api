...
class TransactionFormatter {
   ...
   * @param {Hash} params.redemptionDetails
   *
   * @constructor
   */
  constructor(params) {
  ...
  perform() {
    ...
    if (oThis.params.redemptionDetails && oThis.params.redemptionDetails['redemptionId']) {
      formattedTransactionData.redemption_meta = {
        redeemable_sku_id: oThis.params.redemptionDetails['redemptionProductId'],
        amount_in_fiat: oThis.params.redemptionDetails['amount'],
        country_iso_code: oThis.params.redemptionDetails['country'],
        currency_iso_code: oThis.params.redemptionDetails['currency'],
        redemption_id: oThis.params.redemptionDetails['redemptionId']
      };
    }
