...
class TransactionFormatter {
   ...
   * @param {String} params.blockConfirmation
  ...
  perform() {
    ...
    formattedTransactionData.status = oThis._getStatus(oThis.params.status);
  ...
  _getStatus(status) {
    switch (status) {
      // Mined status is same as success status.
      case pendingTransactionConstants.minedStatus:
        return pendingTransactionConstants.successStatus;
      default:
        return status;
    }
  }
