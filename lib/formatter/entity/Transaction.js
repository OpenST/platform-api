...
class TransactionFormatter {
  ...
  perform() {
    ...
    formattedTransactionData.transaction_fee = oThis.params.transactionFee.toString() || null;
    ...
    if (
      oThis.params.metaProperty['name'] ||
      oThis.params.metaProperty['type'] ||
      oThis.params.metaProperty['details']
    ) {
      formattedTransactionData.meta_property = {
