...
class TransactionFormatter {
  ...
  perform() {
    ...
    if (!oThis.params.hasOwnProperty('transactionUuid') || !oThis.params.hasOwnProperty('updatedTimestamp')) {
    ...
    formattedTransactionData.to = oThis.params.toAddress || null;
    ...
    formattedTransactionData.block_confirmation = oThis.params.blockConfirmation || null;
    formattedTransactionData.status = oThis.params.status || null;
    formattedTransactionData.updated_timestamp = oThis.params.updatedTimestamp;
    ...
    formattedTransactionData.meta_property = oThis.params.metaProperty || {};
