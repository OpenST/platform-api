...
class RedemptionProductFormatter {
   ...
   * @param {Object} params.denominations
   * @param {Number} params.expiryInDays
  ...
  perform() {
    ...
    const formattedRedemptionProductData = {
      ...
      denomination: oThis.params.denomination,
      expiry_in_days: Number(oThis.params.expiryInDays),
