...
class PendingTxFormatter {
  ...
  formatDataForDdb() {
    ...
    if (oThis.params.redemptionDetails) {
      let bufferR = {
        p: oThis.params.redemptionDetails.redemptionProductId,
        a: oThis.params.redemptionDetails.amount,
        co: oThis.params.redemptionDetails.country,
        cu: oThis.params.redemptionDetails.currency,
        i: oThis.params.redemptionDetails.redemptionId
      };
      oThis.formattedParams.redemptionDetails = JSON.stringify(bufferR);
    }
  ...
  formatDataFromDdb() {
    ...
    if (oThis.params.redemptionDetails) {
      let bufferR = JSON.parse(oThis.params.redemptionDetails);
      oThis.formattedParams.redemptionDetails = {
        redemptionProductId: bufferR.p,
        amount: bufferR.a,
        country: bufferR.co,
        currency: bufferR.cu,
        redemptionId: bufferR.i
      };
    }
