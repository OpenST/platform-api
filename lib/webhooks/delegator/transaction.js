...
class Transaction {
  ...
  async _asyncPerform(payload, ic) {
    ...
    */
    ...
    return responseHelper.successWithData({
      ...
      rawEntity: transactionDetails[0]
    });
  }
  ...
  async _fetchData(esConfig, ic, payload) {
    ...
    // This condition is to ensure that extra query on Dynamo is not made.
  ...
  async _fetchTxDetails(ic, payload, esSearchResponse) {
    ...
    const transactionsResponse = await new GetTransactionDetails().perform();
