'use strict';
/**
 * This class file helps in submitting revoke session transaction
 *
...
class RevokeSessionTransaction {
  constructor(params) {
    const oThis = this;
  ...
  async _performTransaction() {
    ...
    let txOptions = {
      ...
      gas: contractConstants.revokeSessionGas,
    ...
    let submitTxRsp = await new SubmitTransaction({
      ...
      pendingTransactionKind: pendingTransactionConstants.revokeSessionKind,
