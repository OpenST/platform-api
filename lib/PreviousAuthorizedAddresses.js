'use strict';
/**
 * This class file helps in fetching the previous authorized address of the given address.
 *
 * @module lib/PreviousAuthorizedAddresses
 */
...
/**
 * Class for fetching previous authorized address.
 *
 * @class
 */
class PreviousAuthorizedAddresses {
  /**
   * Constructor for fetching previous authorized address.
   *
   * @param {Object} params
  ...
  /**
   * Fetches previous authorized address
   *
...
InstanceComposer.registerAsShadowableClass(
  PreviousAuthorizedAddresses,
  coreConstants.icNameSpace,
  'PreviousAuthorizedAddresses'
);
module.exports = PreviousAuthorizedAddresses;
