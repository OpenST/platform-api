...
const rootPrefix = '../..',
  ...
  shardsConstant = require(rootPrefix + '/lib/globalConstant/shards'),
...
class CreateShard {
   ...
   * @param {Number} params.isAvailableForAllocation {true, false}
   */
  constructor(params) {
    const oThis = this;
  ...
  validate() {
    const oThis = this,
      entityKindsMap = shardsConstant.invertedEntityKinds;
