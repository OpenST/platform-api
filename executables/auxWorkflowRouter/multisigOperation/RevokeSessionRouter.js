 ...
 *
 * @module executables/auxWorkflowRouter/multisigOperation/RevokeSessionRouter
 */
...
const rootPrefix = '../../..',
  ...
  revokeSessionStepsConfig = require(rootPrefix +
    '/executables/auxWorkflowRouter/multisigOperation/revokeSessionConfig');
  ...
  async _performStep() {
    ...
    switch (oThis.stepKind) {
      ...
      case workflowStepConstants.revokeSessionPerformTransaction:
        ...
        require(rootPrefix + '/lib/session/Revoke');
