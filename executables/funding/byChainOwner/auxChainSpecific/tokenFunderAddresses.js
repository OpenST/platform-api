 ...
 *
 * @module executables/funding/byChainOwner/auxChainSpecific/tokenFunderAddresses
 *
...
program.on('--help', function() {
  ...
  logger.log('  Example:');
  logger.log('');
  logger.log('    node executables/funding/byChainOwner/auxChainSpecific/tokenFunderAddresses.js --cronProcessId 15');
  logger.log('');
  logger.log('');
});
 ...
 * @class
 */
class FundByChainOwnerAuxChainSpecificTokenFunderAddresses extends AuxChainSpecificFundingCronBase {
  /**
   ...
   */
  get _cronKind() {
    return cronProcessesConstants.fundByChainOwnerAuxChainSpecificTokenFunderAddresses;
  }
...
new FundByChainOwnerAuxChainSpecificTokenFunderAddresses({ cronProcessId: +program.cronProcessId })
  .perform()
  .then(function() {
    process.emit('SIGINT');
  })
